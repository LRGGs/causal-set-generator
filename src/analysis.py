    ...
    for graph in graphs:
        ...
        for path in paths:
            ...
            for i in range(len(path)-2):
                v1 = graph["nodes"][path[i+1]]["position"] - graph["nodes"][path[i]]["position"]
                v2 = graph["nodes"][path[i+2]]["position"] - graph["nodes"][path[i+1]]["position"]
